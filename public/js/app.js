...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    dec: function dec() {
      this.$store.commit('dec', 1);
    },
    getAllState: function getAllState() {// this.$store.dispatch('getAllState')
    }
  },
  computed: {
      ...
      _c(
        ...
        [
          ...
          _vm.isLoggedIn
            ...
            : _vm._e(),
          _vm._v(" "),
          _c("div", [_vm._v(_vm._s(_vm.isLoggedIn))])
        ],
        1
      ),
      _vm._v(" "),
          ...
          _c("div", { staticClass: "card-body" }, [
            _c("h2", [
              ...
              _c("span", { staticClass: "count" }, [
                _vm._v(_vm._s(_vm.handleCount))
              ])
            ]),
            _vm._v(" "),
            _c("button", { on: { click: _vm.inc } }, [_vm._v("+")]),
            _vm._v(" "),
            _c("button", { on: { click: _vm.dec } }, [_vm._v("-")]),
            _vm._v(" "),
            _c("button", { on: { click: _vm.getAllState } }, [
              _vm._v("getAllState")
            ])
          ])
        ])
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "form-group" }, [
      _c("button", { attrs: { type: "submit" } }, [_vm._v("登入")])
    ])
  }
]
render._withStripped = true
...
/* harmony import */ var _module_count__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./module/count */ "./resources/js/store/module/count.js");
/* harmony import */ var _module_config__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./module/config */ "./resources/js/store/module/config.js");
/* harmony import */ var _module_auth__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./module/auth */ "./resources/js/store/module/auth.js");
...
var storeData = new vuex__WEBPACK_IMPORTED_MODULE_1__["default"].Store({
  modules: {
    count: _module_count__WEBPACK_IMPORTED_MODULE_2__["default"],
    config: _module_config__WEBPACK_IMPORTED_MODULE_3__["default"],
    auth: _module_auth__WEBPACK_IMPORTED_MODULE_4__["default"]
  }
});
...
/***/ "./resources/js/store/module/config.js":
/*!*********************************************!*\
  !*** ./resources/js/store/module/config.js ***!
  \*********************************************/
/*! exports provided: default */
...
var state = {
  baseUrl: "http://localhost/blog/public"
};
var mutations = {};
var actions = {};
/* harmony default export */ __webpack_exports__["default"] = ({
...
/***/ "./resources/js/store/module/count.js":
/*!********************************************!*\
  !*** ./resources/js/store/module/count.js ***!
  \********************************************/
/*! exports provided: default */
...
var mutations = {
  inc: function inc(state, data) {
    var oldState = state.count;
    state.count = oldState + data;
  },
  dec: function dec(state, data) {
    var oldState = state.count;
    state.count = oldState - data;
  }
};
...
__webpack_require__(/*! /Applications/Ampps/www/blog/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Applications/Ampps/www/blog/resources/sass/app.scss */"./resources/sass/app.scss");
